...
<body class="hold-transition skin-blue fixed sidebar-mini">
  <div class="wrapper">
          ...
          ?>
            ...
            <li class="dropdown user user-menu" style="padding-right: 15px;">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo web_root.'admin/user/'. $singleuser->PICLOCATION;?>" class="user-image"
                  alt="User Image">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  <img data-target="#menuModal" data-toggle="modal"
                    src="<?php echo web_root.'admin/user/'. $singleuser->PICLOCATION;?>" class="img-circle"
                    alt="User Image" />
                </li>
                <!-- Menu Footer-->
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo web_root.'admin/user/index.php?view=view&id='.$_SESSION['ADMIN_USERID'] ;?>"
    ...
    <footer class="main-footer text-center">
      <strong>Copyright &copy; 2022 <a href="#">Devraj</a>.</strong> All rights
      reserved.
    </footer>
